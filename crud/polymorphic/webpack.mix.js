...
mix.scripts('node_modules/bootstrap/dist/js/bootstrap.bundle.min.js', 'public/js/bootstrap.bundle.min.js').
    scripts('node_modules/bootstrap/dist/js/bootstrap.bundle.min.js.map', 'public/js/bootstrap.bundle.min.js.map').postCss(
        'node_modules/bootstrap/dist/css/bootstrap.min.css', 'public/css/bootstrap.min.css'
    );

mix.scripts('node_modules/simple-mask-money/lib/simple-mask-money.js', 'public/js/simple-mask-money.js');
